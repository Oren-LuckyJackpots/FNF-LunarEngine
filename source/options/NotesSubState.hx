...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		if(title == null) title = 'Note Colors';
		if(rpcTitle == null) rpcTitle = 'Note Colors Menu';
		...
		FlxTween.tween(note, {alpha: 1}, 1, {ease: FlxEase.backInOut, type: ONESHOT});
		var titleText:Alphabet = new Alphabet(75, 40, title, true);
		titleText.scaleX = 0.6;
		titleText.scaleY = 0.6;
		titleText.alpha = 0.4;
		add(titleText);
		FlxTween.tween(titleText, {alpha: 1}, 1, {ease: FlxEase.backInOut, type: ONESHOT});
