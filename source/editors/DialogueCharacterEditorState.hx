...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	function reloadCharacter() {
		...
		DiscordClient.changePresence("In the Dialogue Character Editor", "Editting: " + character.jsonFile.image);
		Lib.application.window.title = MainMenuState.windowName + 'Dialogue Character Editor - Now editting: ' + character.jsonFile.image;
		#end
	}
