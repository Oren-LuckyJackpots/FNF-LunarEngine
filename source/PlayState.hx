...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		Lib.application.window.title = MainMenuState.windowName + detailsText + ' - ' + SONG.song + ' [' + storyDifficultyText + ']';
	...
	public function sortByTime(Obj1:Dynamic, Obj2:Dynamic):Int
	{
